...
const commentsActions = {
    ...
    addComment: (comments) => {
        ...
        return async (dispatch, getState) => {
            const res = await axios.post('https://back-mytinerary.onrender.com/api/itinerarios/comment', { ...comments }, {
                headers: {
    ...
    modifyComment: (idComment, comments) => {
        ...
        return async (dispatch, getState) => {
            try{
            const res = await axios.put('https://back-mytinerary.onrender.com/api/itinerarios/comment/' + idComment,  { comments }, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            })
    ...
    deleteComment: (idComment) => {
        ...
        const token = localStorage.getItem('token')
        return async (dispatch, getState) => {
            const res = await axios.post(`https://back-mytinerary.onrender.com/api/itinerarios/comment/${idComment}`, {}, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
